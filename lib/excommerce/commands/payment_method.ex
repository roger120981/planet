defmodule Excommerce.Command.PaymentMethod do
  use Excommerce.Command, schema: Excommerce.Payments.PaymentMethod
  import Ecto.Query
  ...
  defp enable(payment_method_ids) do
    from payment in Excommerce.Payments.PaymentMethod,
