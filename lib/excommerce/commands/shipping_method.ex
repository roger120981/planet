defmodule Excommerce.Command.ShippingMethod do
  use Excommerce.Command, schema: Excommerce.Shipments.ShippingMethod
  import Ecto.Query
  ...
  defp enable(shipping_method_ids) do
    from shipping in Excommerce.Shipments.ShippingMethod,
