defmodule ExcommerceWeb.ShippingCalculator do
  use GenServer

  alias ExcommerceWeb.ShippingCalculator
  alias Excommerce.Orders.Order
  alias Excommerce.Shipments.ShippingMethod
  ...
  defp shipping_calculator_module(method_name) do
    Application.get_env(:excommerce, :shipping_calculators)[String.to_atom(method_name)]
  end
