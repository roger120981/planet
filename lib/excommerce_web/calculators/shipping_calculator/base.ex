defmodule ExcommerceWeb.ShippingCalculator.Base do
  @callback calculate_shipping(Excommerce.Shipments.ShippingUnit.t) :: any
  @callback applicable?(Excommerce.Shipments.ShippingUnit.t) :: any
  @callback shipping_rate(Excommerce.Shipments.ShippingUnit.t) :: any
  ...
  def add_shipping_methods(shipping) do
    quote location: :keep do
      ...
      @behaviour ExcommerceWeb.ShippingCalculator.Base
