defmodule ExcommerceWeb.Gateway do
  ...
  defp selected_payment_method(selected_payment_id) do
    Excommerce.Repo.get!(Excommerce.Payments.PaymentMethod, selected_payment_id) |> Map.get(:name)
  end
  ...
  def payment_module(method_name) do
    Module.concat(ExcommerceWeb.Gateway, (Macro.camelize method_name))
  end
end
