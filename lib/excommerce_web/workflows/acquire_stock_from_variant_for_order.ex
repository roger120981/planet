defmodule ExcommerceWeb.Workflow.AcquireStockFromVariantForOrder do
  ...
  def steps(repo, order) do
    ...
    Enum.reduce(order.line_items, Multi.new(), fn(line_item, multi_acc) ->
      ...
      Multi.append(multi_acc, ExcommerceWeb.Workflow.AcquireStockFromVariant.steps(variant, quantity))
    end)
  end
end
