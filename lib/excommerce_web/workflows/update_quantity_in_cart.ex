defmodule ExcommerceWeb.Workflow.UpdateQuantityInCart do
  ...
  def steps(line_item, variant, quantity) do
    ...
    |> Multi.append(ExcommerceWeb.Workflow.CheckVariantAvailability.steps(variant, requested_quantity, changeset))
  ...
  defp line_item_update_quantity_changeset(line_item, quantity) do
    Excommerce.Orders.LineItem.quantity_changeset(line_item, %{add_quantity: quantity})
  end
