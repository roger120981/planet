defmodule ExcommerceWeb.Workflow.Checkout.Tax do
  alias Ecto.Multi
  ...
  def changeset_for_step(order, params \\ %{}) do
    Excommerce.Orders.Order.tax_changeset(order, params)
  end
  ...
  def post_transition(repo, order) do
    Multi.new()
    |> Multi.append(ExcommerceWeb.Workflow.SettleAdjustmentAndProductPaymentForOrder.steps(repo, order))
    |> repo.transaction()
  end
end
