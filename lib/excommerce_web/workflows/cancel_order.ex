defmodule ExcommerceWeb.Workflow.CancelOrder do
  alias Ecto.Multi
  ...
  def cancel_line_order_fullfillment(_changes, repo, order) do
    ...
    line_item_cancellations = Stream.map(line_items, &(ExcommerceWeb.Workflow.CancelLineItemFullfillment.run(repo, &1)))
