defmodule ExcommerceWeb.Admin.LineItemController do
  use ExcommerceWeb, :admin_controller

  alias Excommerce.Orders.LineItem
  alias ExcommerceWeb.CartManager
  ...
  def update_fullfillment(conn, %{"order_id" => _id, "line_item_id" => line_item_id}) do
    ...
    case ExcommerceWeb.Workflow.CancelLineItemFullfillment.run(Repo, line_item) do
      {:ok, _line_item} ->
        conn
        |> put_status(:no_content)
        |> json(nil)
